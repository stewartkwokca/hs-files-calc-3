...
from numpy.linalg import det as d # for testing purposes

# used for testing
def genTestSquareMatrix(rows):
    return [[randint(-100, 100) for j in range(rows)] for i in range(rows)]

test = genTestSquareMatrix(5) # for testing purposes
